...
def run_all_refine_ls49_JF1M(ts=None, ls49_data_dir=None, show_plotted_images=False, outdir=None, params=None, seed=0.0):
    ...
    if False:
      ...
      nbcryst_final.Ncells_abc_0 = 5,5,5 #Ncells_abc, Ncells_abc, Ncells_abc
    ...
    if False:
      ...
      nbcryst_final.thick_mm = 0.005
      nbcryst_final.miller_array = data["sfall"]
      #nbcryst_final.HA_miller_array = data["HA_sfall"]
      #nbcryst_final.HA_miller_array = data["HA_sfall_fp"]
      #nbcryst_final.HA_miller_array = data["HA_sfall_fdp"]
